...
class MultiQueryRAGTinyLlama:
    ...
    def generate_query_variations(self, query: str, num_variations: int = 3) -> List[str]:
        """Generate multiple query variations using TinyLlama."""
...
def main():
    ...
    system = MultiQueryRAGTinyLlama(NEO4J_URI, NEO4J_USER, NEO4J_PASSWORD, DATABASE)
