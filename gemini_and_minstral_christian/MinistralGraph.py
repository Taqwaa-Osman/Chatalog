...
class GraphRAGMinistral3:
    ...
    def generate_response(self, query: str, context: str, books: List[Dict[str, Any]] = None, stream: bool = False) -> str:
        """Generate response using ministral-3:3b with Chatalog persona."""
        if not books:
...
def main():
    ...
    system = GraphRAGMinistral3(NEO4J_URI, NEO4J_USER, NEO4J_PASSWORD, DATABASE)
