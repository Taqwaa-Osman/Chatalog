    ...
    def _verify_ollama(self):
        try:
            ...
            if not any('ministral-3:3b' in name.lower() for name in model_names):
                raise RuntimeError("ministral-3:3b not found. Run: ollama pull ministral-3")
        except Exception as e:
...
def main():
    ...
    system = SubGraphRAGMinistral3(NEO4J_URI, NEO4J_USER, NEO4J_PASSWORD, DATABASE)
